...
def track(img,darknet_image,network,class_names,moving):
	...
	try:
		...
		pts = np.array([[230,540],[230,700],[530,700],[530,540]])
		...
		#img = cv2.line(img, (630,line1), (870,line1), (0, 255, 0),2)
		#img = cv2.line(img, (630,line3), (870,line3), (0, 255, 0),2)
		#img = cv2.line(img, (630,line2), (870,line2), (255, 0, 0),2)
		if is_first == 1:
