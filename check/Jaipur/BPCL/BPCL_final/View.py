...
def view_detection(view_coords,view_scores,roi):
	...
	for person in range(0,roi):
		...
		print("diff", (right_shoulder_x - nose_x))
		print("nose-->x",nose_x+42)
		#print("nose-->y",nose_y)
		print("left_shoulder_x", left_shoulder_x)
		if (((nose_score >= 0.1) and ((nose_x+32 > left_shoulder_x and nose_x+32 > right_shoulder_x) and (left_ear_score >= 0.07 and right_ear_score >= 0.07)))  or ( left_ear_score < 0.1 and right_ear_score >= 0.08  and (nose_x+32 > left_shoulder_x and nose_x+32 > right_shoulder_x) and ((right_shoulder_x - nose_x) < 45)) or ( right_ear_score < 0.1 and left_ear_score >= 0.08  and (nose_x+32 > left_shoulder_x and nose_x+32 > right_shoulder_x) and ((right_shoulder_x - nose_x) < 45))) :
