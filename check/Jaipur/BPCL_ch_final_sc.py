...
sc1=VideoStream('172.20.50.22',8096)
		...
		while True:
			...
			if moving == True:
				...
				if number_roi >= 1 and number_view == 0:
					output, number_motion = helmet.helmet(img1)
					if output == True :
						Timer.timer("direction",True,cam1)
						View_draw =  True
					else:
				...
				if number_roi >= 1 and number_view >=  1 and number_motion == 0:
					...
					Motion_draw = False
				img1 = cv2.putText(img1, "Person in ROI: "+str(Roi_draw) , (20,70), cv2.FONT_HERSHEY_SIMPLEX , 1.1,  (204,255,230) , 3, cv2.LINE_AA)
				if number_view >= 1 and number_motion ==1:
					img1 = cv2.putText(img1, "Person Attentiveness: True" , (20,120), cv2.FONT_HERSHEY_SIMPLEX , 1.1,  (204,255,230) , 3, cv2.LINE_AA)
				else:
					img1 = cv2.putText(img1, "Person Attentiveness: False" , (20,120), cv2.FONT_HERSHEY_SIMPLEX , 1.1, (204,255,230) , 3, cv2.LINE_AA)
